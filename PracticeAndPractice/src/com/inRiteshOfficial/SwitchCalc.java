...
public class SwitchCalc {
	...
	public static void main(String[] args) {
		...
		case 1: System.out.println("enter first number"); //subtraction
		int A=scan.nextInt();
		...
		break;
		case 2: System.out.println("enter first number"); //multiplication
		int e=scan.nextInt();
		...
		break;
		case 3: System.out.println("enter first number"); //addition
		int a=scan.nextInt();
		...
		break;
		case 4: System.out.println("enter first number"); //division
		int E=scan.nextInt();
